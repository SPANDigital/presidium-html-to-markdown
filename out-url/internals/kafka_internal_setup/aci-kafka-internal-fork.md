...
### Branches[Internal Link: ¶](\#branches)

#### Apache Kafka upstream branches[Internal Link: ¶](\#apache-kafka-upstream-branches)

- The upstream Apache Kafka project hosts it’s code on
  [External Link: https://github.com/apache/kafka](https://github.com/apache/kafka). Development happens in the
...
#### Internal branches and the mechanics of a release[Internal Link: ¶](\#internal-branches-and-the-mechanics-of-a-release)

- Each upstream release, such as `2.1.1` has a develop branch in the
  [External Link: https://github.pie.apple.com/pie/apache-kafka](https://github.pie.apple.com/pie/apache-kafka) repository, in
...
### Scala version[Internal Link: ¶](\#scala-version)
