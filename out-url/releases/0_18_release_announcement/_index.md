...
[External Link: Artifactory](https://artifacts.apple.com/pie-release-local/com/apple/pie/queue/kafka-pie-client/0.18.2)
...
of JDK8 is
[External Link: deprecated](https://java.apple.com/applejdk.html#AppleJDKVersions), if
are still using JDK8 you should move to JDK11. If you really need JDK8
compatibility please use the latest
[External Link: 0.17](https://artifacts.apple.com/pie-release-local/com/apple/pie/queue/kafka-pie-client/0.17.6)
release.
...
- Reduced rebalances, more stability in Consumer Groups with [External Link: Static
  Membership](https://kafka.apache.org/25/documentation.html#static_membership)
...
- The default consumer group id has been changed from the empty string
  ...
  [External Link: KIP-289](https://cwiki.apache.org/confluence/display/KAFKA/KIP-289%3A+Improve+the+default+group+id+behavior+in+KafkaConsumer).
...
- The blocking `KafkaConsumer#committed` methods have been extended to
  ...
  [External Link: KIP-520](https://cwiki.apache.org/confluence/display/KAFKA/KIP-520%3A+Add+overloaded+Consumer%23committed+for+batching+partitions)).
...
changes for
[External Link: 2.2](https://kafka.apache.org/documentation.html#upgrade_220_notable),
[External Link: 2.3](https://kafka.apache.org/documentation.html#upgrade_230_notable) and
[External Link: 2.4](https://kafka.apache.org/documentation.html#upgrade_240_notable) in
