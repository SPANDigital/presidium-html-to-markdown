...
- [External Link: QTIP-028 - PIE Envelope
  Deprecation](https://github.pie.apple.com/pie/kafka-tools/blob/develop/improvement-proposals/028-envelope-deprecation.md),
  also see [Internal Link: ACI Kafka Docs](../client/envelope.html)
- [External Link: QTIP-029 - Iris Service for Scalable and Secure Key
  Distribution](https://github.pie.apple.com/pie/kafka-tools/blob/develop/improvement-proposals/029-iris-service.md)
- [External Link: ACI Kafka CLI](https://packages.apple.com/pypi/pie-kafka-cli)
...
More details can be found in the [Internal Link: PIE Envelope Deprecation and Migration
page](../client/envelope.html#pieenvelope-deprecation-and-migration-details),
and for teams using Kafka for All, [Internal Link: ACI Kafka Java client
interoperability (ACI Kafka
0.14+)](../client/kafka_for_all.html#aci-kafka-java-client-interoperability-aci-kafka-0-15)
provides an explanation of the implications for non-ACI Kafka clients.

**Iris: Front-end service for e2e crypto keys**

For users depending on the [Internal Link: e2e crypto
feature](../client/security_settings.html#payload-encryption-and-decryption-settings),
...
interested in onboarding, please [Internal Link: contact
us](../contact.html#on-boarding-or-expansion).

This CLI is based on a Python library that can be integrated with
existing automation. You can learn more at [External Link: Apple
...
supports [External Link: IS&T’s transition to the corporate certificate
...
We also now support a [Internal Link: GSLB-enabled
endpoint](../client/kaffe.html#kaffe-endpoints)
