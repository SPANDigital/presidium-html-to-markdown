...
### Tiered storage[Internal Link: ¶](\#tiered-storage)
...
[Internal Link: contact](../contact.html) us.

### Other highlights[Internal Link: ¶](\#other-highlights)

- [External Link: KIP-890](https://cwiki.apache.org/confluence/display/KAFKA/KIP-890%3A+Transactions+Server-Side+Defense) transactions in Kafka have been a prominent source of problems. This
  change aims to prevent hanging transaction issues.
- [External Link: KIP-863](https://cwiki.apache.org/confluence/pages/viewpage.action?pageId=225152035) improves memory allocation and performance during deserialization.

For a complete list of changes, please consult the [External Link: release notes for Kafka 3.6](https://downloads.apache.org/kafka/3.6.0/RELEASE_NOTES.html).

For a general overview of what’s new in Kafka 3.6, read [External Link: this post](https://kafka.apache.org/blog#apache_kafka_360_release_announcement) in the Apache Kafka
blog.
...
For questions about this release or general inquiries related to ACI Kafka, [Internal Link: contact the ACI Kafka team](../contact.html).
