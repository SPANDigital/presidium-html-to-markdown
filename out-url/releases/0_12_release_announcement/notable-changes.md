...
view, check out the [Internal Link: portal
docs](../self-service/portal.html) for more
information.
...
- IF1: [External Link: kafka.pie.apple.com/if1](https://kafka.pie.apple.com/if1).
- IF-PROD:
  [External Link: kafka.pie.apple.com/prod](https://kafka.pie.apple.com/prod).

Note: If you are connecting over VPN, you may need to switch to full
tunnel VPN to resolve these new subdomains; [External Link: check out the IS&T
...
- [External Link: rdar://problem/39546710](https://rdar.apple.com/39546710) PIE
