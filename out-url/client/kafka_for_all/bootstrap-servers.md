...
You can fetch the Namespace state using the [Internal Link: CLI](../self-service/kafka_cli.html#fetch-single-namespace) or the [Internal Link: API](../self-service/public_api.html#fetch-single-namespace).
