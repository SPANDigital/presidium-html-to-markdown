...
You can use our [Internal Link: Sidecar
Solution](../dev-and-ci.html#local-environments) for integrating the
ACI Kafka Client with a local Apache Kafka cluster. See the 0.9.x
[Internal Link: Dev Mode Flag](../dev-and-ci.html#local-environments) feature for
...
needed for [Internal Link: end-to-end
crypto](security_settings.html#payload-encryption-and-decryption-settings),
if enabled. More on Kaffe and client configuration and secure secrets
injection can be found in the [Internal Link: Kaffe documentation](kaffe.html).
...
configured for [Internal Link: Default Configuration
Injection](default_config_injection.html) using Kaffe
