...
our [Internal Link: consumer settings
docs](consumer_settings.html#consumer-group-and-aci-kafka-client).
...
If you want to know more about see the [External Link: PIE Spark
