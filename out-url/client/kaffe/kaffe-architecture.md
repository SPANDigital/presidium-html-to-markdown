...
### Protocol[Internal Link: ¶](\#protocol)

Kaffe is a gRPC service. It’s [External Link: protocol
definition](https://github.pie.apple.com/pie/kafka-tools/blob/develop/kaffe-client/src/main/proto/kaffe.proto)
