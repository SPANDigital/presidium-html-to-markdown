...
For more about configuring idempotent Producer, check [Internal Link: recommended configurations](producer_settings.html#idempotent-producer-and-transactional-producer).
...
![](http://client/../_images/producer-idempotent.png)

For more details on Idempotent Producer check [External Link: EOS blog](https://www.confluent.io/blog/exactly-once-semantics-are-possible-heres-how-apache-kafka-does-it/)).
