...
[External Link: Synthetic Monitor dashboard](https://aci-kafka.grafana.telemetry.g.apple.com/d/d421ddc0-a18f-467f-93ae-3b71132999cf/synthetic-monitor).

Note

If you can’t access the dashboard please self-join [External Link: aci-kafka-announce Apple Directory group](adir://joingroup/670759).
