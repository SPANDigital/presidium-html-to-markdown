...
Your ACI Kafka topic name will be prefixed with your [customer group and namespace](http://troubleshooting/../concepts.html#namespace).
...
### Finding your ACI Kafka cluster name [¶](http://troubleshooting\#finding-your-aci-kafka-cluster-name "Link to this heading")
...
#### Using the CLI or the API [¶](http://troubleshooting\#using-the-cli-or-the-api "Link to this heading")

You can use [the CLI](http://troubleshooting/../self-service/kafka_cli.html#fetch-single-namespace) or [the Public API](http://troubleshooting/../self-service/public_api.html#fetch-single-namespace) if you’re familiar with them.

#### Using the API in the browser [¶](http://troubleshooting\#using-the-api-in-the-browser "Link to this heading")
...
#### From the bootstrap.servers [¶](http://troubleshooting\#from-the-bootstrap-servers "Link to this heading")
