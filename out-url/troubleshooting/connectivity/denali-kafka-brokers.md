...
If you wish to connect to ACI Kafka clusters from AWS@Apple or another [Denali](https://denali.sdi.apple.com)-secured platform, use the following security profiles depending on the environment the Kafka cluster is in:

### Kafka brokers in Apple Owned Data Centers (AODC) [¶](http://troubleshooting\#kafka-brokers-in-apple-owned-data-centers-aodc "Link to this heading")
...
- [`/ISS/ACI/Kafka/Kubev2`](https://networkpolicy.sdi.g.apple.com/security-profile?securityProfileId=b91a312a-c68c-4245-b26e-d286a4b06495)
- `ACI Kafka - <cluster-name>` – if this profile exists on Denali. You can map your [namespace to a cluster name](http://troubleshooting/../faq/index.html#what-cluster-does-my-aci-kafka-namespace-live-on) using our self-service mechanisms.

You may want to refer to Denali documentation, or #help-denali.

### Kafka brokers in AWS@Apple [¶](http://troubleshooting\#kafka-brokers-in-aws-apple "Link to this heading")
...
### Applications running in Kube [¶](http://troubleshooting\#applications-running-in-kube "Link to this heading")
...
### Supporting Services (e.g. Kaffe) [¶](http://troubleshooting\#supporting-services-e-g-kaffe "Link to this heading")
...
### What about connecting to QA (IF1)? [¶](http://troubleshooting\#what-about-connecting-to-qa-if1 "Link to this heading")
