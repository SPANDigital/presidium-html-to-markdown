...
You can [Internal Link: reach out to the team](../contact.html) if you would like to use a Kubernetes cluster that isn’t part of this list.

\* **QA only**: Available for QA (if1) resources only.

### Exploring ACI Kafka CRDs with `kubectl explain`[Internal Link: ¶](\#exploring-aci-kafka-crds-with-kubectl-explain)
