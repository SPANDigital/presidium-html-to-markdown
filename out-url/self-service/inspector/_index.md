...
For more details check [Internal Link: broker metrics](../monitoring/broker_metrics.html).
...
- For Prod: [External Link: https://ui-prod.aci-kafka.apple.com/inspector/](https://ui-prod.aci-kafka.apple.com/inspector/)
- For IF1: [External Link: https://ui-if1.aci-kafka.apple.com/inspector/](https://ui-if1.aci-kafka.apple.com/inspector/)

You should then be able to navigate to the cluster of choice, which will
present you the following view:

![](http://self-service/../_images/inspector.png)
