...
[External Link: guide for configuring the instrumentation](https://github.com/open-telemetry/opentelemetry-java-instrumentation/tree/v2.4.0/instrumentation/kafka/kafka-clients/kafka-clients-2.6/library#usage-metrics),
