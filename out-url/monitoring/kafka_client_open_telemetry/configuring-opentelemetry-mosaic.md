...
Follow the [External Link: Mosaic documentation](https://telemetry.apple.com/docs/collection/opentelemetry).

If using the Java agent or autoconfigured SDK, you’ll need at least the following set of config to export metrics to
the [External Link: Mosaic OpenTelemetry Metrics Gateway](https://telemetry.apple.com/blog/mosaic-otlp-metrics-gateway).
