...
The table below lists the [External Link: data tiers](https://infosec.apple.com/guidance/policies/all/information-classification/) supported by ACI Kafka, **with some important exceptions (below)**. The minimum
[External Link: data handling requirements](https://infosec.apple.com/guidance/policies/all/information-classification/) are also included.
...
For any of the following data types, you must reach out to [Internal Link: ASE Compliance](mailto:ASE_Compliance%40group.apple.com) before leveraging an ASE Service:
