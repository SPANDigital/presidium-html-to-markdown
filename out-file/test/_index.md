...
[External Link: adir://groups/1227975](adir://groups/1227975)
 `adir://groups/1227975`
[Internal Link: Send email](mailto:someone@example.com)
...
![](http://./download/attachments/4439017778/rerun.png?version=3&modificationDate=1672780660942&api=v2)
...
2. the policy being configured for the above
    pattern. either owners or watchers (map)


1. target of the policy in the form
    _name_: user \| team (map)
...
`curl -X POST "`[External Link: https://ase-stewards-api.itunes.apple.com/rest/v3/owners/search](https://ase-stewards-api.itunes.apple.com/rest/v3/owners/search) `" -H "accept: application/json" -H "Content-Type: application/json" -d '{"host":"github.pie.apple.com","repo_owner":"its","repo_name":"Jingle","paths":["ragglefraggle","owners.yaml"]}'`
