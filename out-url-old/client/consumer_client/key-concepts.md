...
### Consumer Group (a.k.a `group.id` config) [¶](#consumer-group-a-k-a-group-id-config "Link to this heading")
...
![]({{%baseurl%}}//images/consumer_group.png)

You need to be familiar with the following two concepts related to groups:

#### 1\. Group Coordinator [¶](#group-coordinator "Link to this heading")
...
#### 2\. Group Member [¶](#group-member "Link to this heading")
...
### Poll [¶](#poll "Link to this heading")
...
### Offset Commit [¶](#offset-commit "Link to this heading")
...
### Heartbeat [¶](#heartbeat "Link to this heading")
...
Check the [configuration section](#key-configurations) for more details on how to set the value of `heartbeat.interval.ms`.
...
### Rebalance [¶](#rebalance "Link to this heading")
...
For more details on the consumer concept, please check [Chapter 4 - Kafka: The Definitive Guide, 2nd Edition](https://learning.oreilly.com/library/view/kafka-the-definitive/9781492043072/ch04.html).
