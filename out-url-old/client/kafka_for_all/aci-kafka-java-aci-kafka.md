...
serialized inside of the [PieEnvelope]({{< ref "client/envelope" >}}). Now that Kafka
has added record headers, there is a plan to deprecate `PieEnvelope`,
detailed in [PieEnvelope\
Deprecation]({{%baseurl%}}/envelope.html#pieenvelope-deprecation-and-migration-details)
section of our docs.
