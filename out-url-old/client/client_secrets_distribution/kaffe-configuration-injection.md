...
### What will Kaffe configuration injection do? [¶](#what-will-kaffe-configuration-injection-do "Link to this heading")
...
### Configuring your client to enable Kaffe configuration injection [¶](#configuring-your-client-to-enable-kaffe-configuration-injection "Link to this heading")
...
It’s easy with [PIE Secrets](https://docs.aci.apple.com/secrets) to add
