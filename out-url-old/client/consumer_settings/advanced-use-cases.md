...
### Exactly-Once consumer [¶](#exactly-once-consumer "Link to this heading")
...
### Multi-threaded consumer [¶](#multi-threaded-consumer "Link to this heading")
...
![]({{%baseurl%}}//images/consumer_multi_threading.png)
