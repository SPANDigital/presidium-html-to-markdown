...
### 3\. Record accumulator [¶](#record-accumulator "Link to this heading")
...
### 4\. Compression [¶](#compression "Link to this heading")
...
Check our recommendations for [compression]({{%baseurl%}}/producer_settings.html#optimize-for-latency-vs-throughput).

### 5\. Sender Thread [¶](#sender-thread "Link to this heading")
...
For more details about the Producer, check [Chapter 3 - Kafka: The Definitive Guide, 2nd Edition](https://learning.oreilly.com/library/view/kafka-the-definitive/9781491936153/ch03.html)
