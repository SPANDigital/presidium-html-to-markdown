...
The quota is enforced on all [client identities](#client-identities) on a per-broker basis to safeguard multi-tenant clusters.
...
To learn more about the Apache Kafka quota management design, see [KIP-13 - Quotas](https://cwiki.apache.org/confluence/display/KAFKA/KIP-13+-+Quotas).
