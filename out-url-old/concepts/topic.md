...
### Topic name [¶](#topic-name "Link to this heading")
...
### Topic retention [¶](#topic-retention "Link to this heading")
...
From the [Kafka Topic-Level Configuration Documentation]({{%baseurl%}}/https://kafka.apache.org/documentation.html#topicconfigs):
...
### Topic quotas [¶](#topic-quotas "Link to this heading")
