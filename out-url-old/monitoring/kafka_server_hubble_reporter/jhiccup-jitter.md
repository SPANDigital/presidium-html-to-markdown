...
[jHiccup](https://github.com/giltene/jHiccup). The idea is to compute
...
![image]({{%baseurl%}}//images/jhiccup_hubble.png){height=”400px”}
...
seconds. [JHiccup](https://github.com/giltene/jHiccup) has the advantage
...
entire [HdrHistogram](https://hdrhistogram.github.io/HdrHistogram/) to a file by setting
...
If you write this file you can use the [Excel document in the jHiccup\
repo]({{%baseurl%}}//files/jHiccupPlotter.xls)
