...
The following sections describe how you can interact with the ACI Kafka CRDs, once you have finished [onboarding](#onboarding).

### List topics and client identities [¶](#list-topics-and-client-identities "Link to this heading")
...
### Delete a topic or a client identity [¶](#delete-a-topic-or-a-client-identity "Link to this heading")
...
### Describe a specific topic [¶](#describe-a-specific-topic "Link to this heading")
...
### Create a new topic [¶](#create-a-new-topic "Link to this heading")
...
### Update a topic [¶](#update-a-topic "Link to this heading")
...
### Create a new client identity [¶](#create-a-new-client-identity "Link to this heading")
...
### Describe a specific client identity [¶](#describe-a-specific-client-identity "Link to this heading")
