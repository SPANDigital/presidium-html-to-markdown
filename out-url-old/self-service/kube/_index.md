...
[custom resource definitions (CRDs)](https://kubernetes.io/docs/concepts/extend-kubernetes/api-extension/custom-resources/#customresourcedefinitions) such as `KafkaTopic`, `KafkaClientIdentity` and `KafkaCustomerGroupBinding`.
