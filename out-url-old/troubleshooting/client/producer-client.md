...
### Producer failed to send record [¶](#producer-failed-to-send-record "Link to this heading")
...
#### Impact [¶](#id17 "Link to this heading")
...
#### Causes and Solutions [¶](#id18 "Link to this heading")
...
- If network connectivity isn’t the problem, then make sure `retires` is not set to a low value.
  Please follow our [recommendation for best delivery guarantee]({{%baseurl%}}/../client/producer_settings.html#best-delivery-guarantee)
...
- Make sure [topic access]({{%baseurl%}}/../concepts.html#client-identity-topic-access) and authorization are set up correctly.
...
### Missing data [¶](#missing-data "Link to this heading")
...
### Throughput or latency issues [¶](#throughput-or-latency-issues "Link to this heading")
...
- Enable compression by setting `compression.type=zstd`
  More details can be found [here]({{%baseurl%}}/../client/producer_settings.html#optimize-for-latency-vs-throughput)

1. If none of the these solutions offered improvement, please consider:

- Checking our recommendations on how to optimize for Latency vs Throughput [here]({{%baseurl%}}/../client/producer_settings.html#optimize-for-latency-vs-throughput)
