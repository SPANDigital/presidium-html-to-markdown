...
[Vessel](https://vessel.apple.com/) or Docker are prerequisites for running
...
[compat mode](https://vessel.apple.com/usage/docker-compatibility/compat-mode)
...
Please refer to [version mapping]({{%baseurl%}}/releases/index.html#apache-kafka-version-mapping)
