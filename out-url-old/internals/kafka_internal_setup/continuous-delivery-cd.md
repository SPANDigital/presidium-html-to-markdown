...
### How? [¶](#how "Link to this heading")

- Any change in ACI Kafka and ACI Kafka tools triggers
  [pie-kafka-tools-master-carnival-1build](https://rio.apple.com/projects/pie-kafka-tools/pipeline-specs/pie-kafka-tools-master-carnival-1build/pipelines)
  job.
- Refer [trigger\
  CD]({{%baseurl%}}/https://github.pie.apple.com/pie/apache-kafka/blob/develop-0.10/rio.yml#L41)
  and [CD in\
  rio.yml]({{%baseurl%}}/https://github.pie.apple.com/pie/kafka-tools/blob/develop/rio.yml#L73).
- This job
  [deploys]({{%baseurl%}}/https://github.pie.apple.com/pie/kafka-tools/blob/develop/rio.yml#L85)
