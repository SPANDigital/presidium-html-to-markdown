...
The ACI Kafka 0.23 client is available on [Artifactory](https://artifacts.apple.com/pie-release-local/com/apple/pie/queue/kafka-pie-client).
...
For details please consult the [release notes for Kafka 3.1](https://archive.apache.org/dist/kafka/3.1.0/RELEASE_NOTES.html).
Or, for general overview on what’s new in Kafka 3.1 you might be interested in [this post](https://blogs.apache.org/kafka/entry/what-s-new-in-apache7) in the Apache Kafka
blog.
