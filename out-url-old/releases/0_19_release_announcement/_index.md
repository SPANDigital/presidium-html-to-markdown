...
This release is based on our [internal\
...
See
[KIP-573]({{%baseurl%}}/https://cwiki.apache.org/confluence/display/KAFKA/KIP-573%3A+Enable+TLSv1.3+by+default)
for more details.
...
See
[KIP-602]({{%baseurl%}}/https://cwiki.apache.org/confluence/display/KAFKA/KIP-602%3A+Change+default+value+for+client.dns.lookup)
for more details.
...
It is no longer possible to use live objects in configuration, as [one\
of the private\
...
changes for
[2.5]({{%baseurl%}}/https://kafka.apache.org/documentation.html#upgrade_250_notable) and
[2.6]({{%baseurl%}}/https://kafka.apache.org/documentation.html#upgrade_260_notable) in
