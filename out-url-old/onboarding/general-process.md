...
### Team Name and Contact Info [¶](#team-name-and-contact-info "Link to this heading")
...
### Timeline / Go-Live Dates [¶](#timeline-go-live-dates "Link to this heading")
...
### Data In [¶](#data-in "Link to this heading")
...
### Data Out [¶](#data-out "Link to this heading")
...
in [Namespace]({{%baseurl%}}/concepts.html#namespace)
section and in the questionnaire for your reference.
...
### [Customer Groups]({{%baseurl%}}/concepts.html\#customer-group) [¶](#customer-groups "Link to this heading")
...
form of AD group(s). Please see [Customer\
Group]({{%baseurl%}}/concepts.html#customer-group)
section in our concepts page and ensure that you follow the naming
conventions. [Access\
Info]({{%baseurl%}}/concepts.html#customer-group-access-control)
and [Contact\
Info]({{%baseurl%}}/concepts.html#customer-group-contact-information)
...
### [Namespace]({{%baseurl%}}/concepts.html\#namespace) [¶](#namespace "Link to this heading")
